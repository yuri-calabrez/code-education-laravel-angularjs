...
class CodeProjectRepositoryProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind(Repositories\UserRepositoryInterface::class, Repositories\UserRepositoryEloquent::class);
        ...
        $this->app->bind(Repositories\ProjectMemberRepositoryInterface::class, Repositories\ProjectMemberRepositoryEloquent::class);
        $this->app->bind(Repositories\ProjectFileRepositoryInterface::class, Repositories\ProjectFileRepositoryEloquent::class);
    }
}
